...
var AirPlane = function(){
  ...
  var matPropeller = new THREE.MeshPhongMaterial({color:Colors.yellow, shading:THREE.FlatShading});
  ...
  var wheelAxisMat = new THREE.MeshPhongMaterial({color:Colors.gray, shading:THREE.FlatShading});
